...
/* Line 189 of yacc.c  */
#line 148 "release/yacc_lex/ConfigParser_yacc.cpp"
...
/* Line 214 of yacc.c  */
#line 197 "release/yacc_lex/ConfigParser_yacc.cpp"
} YYSTYPE;
...
/* Line 264 of yacc.c  */
#line 209 "release/yacc_lex/ConfigParser_yacc.cpp"
...
{
       0,     0,     3,     6,     7,    12,    15,    16,    20
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
       9,     0,    -1,    10,     9,    -1,    -1,     3,     6,    11,
       4,    -1,    12,    11,    -1,    -1,     6,     5,     6,    -1,
       6,     5,     7,    -1
};
...
{
  "$end", "error", "$undefined", "BEGIN_TK", "END_TK", "EQUAL", "VARNAME",
  "VALUE", "$accept", "config", "begin_end", "declarations", "declaration", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 99 "Config/ConfigParser.y"
    { store_scope( (yyvsp[(2) - (4)].str) );                   ;}
    break;

  case 6:

/* Line 1455 of yacc.c  */
#line 103 "Config/ConfigParser.y"
    {                                      ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 107 "Config/ConfigParser.y"
    { store_to_map( (yyvsp[(1) - (3)].str), (yyvsp[(3) - (3)].str) );              ;}
    break;

  case 8:

/* Line 1455 of yacc.c  */
#line 109 "Config/ConfigParser.y"
    { store_to_map( (yyvsp[(1) - (3)].str), (yyvsp[(3) - (3)].str) );              ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 1429 "release/yacc_lex/ConfigParser_yacc.cpp"
      default: break;
    }
...
/* Line 1675 of yacc.c  */
#line 111 "Config/ConfigParser.y"
...
{
  for( map<string, CONFIG *>::iterator itr = config_root->begin();
       itr != config_root->end(); itr ++ )
  {
    delete itr->second;
  }
