...
**
** Created: Sat Aug 27 08:24:45 2011
...
static const char qt_meta_stringdata_Server[] = {
    "Server\0\0newConnection(QTcpSocket*)\0"
    "message\0updateServer(std::string)\0"
};
...
int Server::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: newConnection((*reinterpret_cast< QTcpSocket*(*)>(_a[1]))); break;
        case 1: updateServer((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
